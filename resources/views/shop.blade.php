                ...
                <div class="col-12">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Của Hàng</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <ul class="category-list">
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label" for="flexCheckDefault19">5% trở lên</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label" for="flexCheckDefault20">10% trở lên</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label" for="flexCheckDefault21">20% trở lên</label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="select-options">
                                    <div class="page-view-filter">
                                        <div class="dropdown select-featured">
                                            <select class="form-select" name="orderby" id="orderby">
                                                ...
                                                <option value="1">Ngày, Mới Đến Cũ</option>
                                                <option value="2">Ngày, Cũ Đến Mới</option>
                                    ...
                                    <div class="dropdown select-featured">
                                        <select class="form-select" name="size" id="pagesize">
                                            <option value="12" selected="">12 sản phẩm trên mỗi trang</option>
                                            <option value="24">24 sản phẩm trên mỗi trang</option>
                                            <option value="52">52 sản phẩm trên mỗi trang</option>
                                            <option value="100">100 sản phẩm trên mỗi trang</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        ...
                                        <button class="btn listing-content">Thêm vào giỏ hàng</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6">
                    <div class="subscribe-details">
                        <h2 class="mb-3">Theo dõi tin tức của chúng tôi</h2>
                        <h6 class="font-light">Đăng ký và nhận bản tin của chúng tôi để theo dõi tin tức về sản phẩm mới của chúng tôi
                            và các sản phẩm tuyệt vời.</h6>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-3">
                    <div class="subsribe-input">
                        <div class="input-group">
                            <input type="text" class="form-control subscribe-input" placeholder="Địa Chỉ Email">
                            <button class="btn btn-solid-default" type="button">Gửi</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                success:function(data){
                    if(data.status==200){
                        $.notify({
                            icon:"fa fa-check",
                            title:"Succes!",
                            message:"Item successfuly added to your wishlist"
                        })
                    }
