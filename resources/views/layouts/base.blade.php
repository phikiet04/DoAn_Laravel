                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('app.index')}}" class="nav-link menu-title">Trang chủ</a></li>
                                            <li><a href="{{route('shop.index')}}" class="nav-link menu-title">Cửa hàng</a></li>
                                            <li><a href="{{route('cart.index')}}" class="nav-link menu-title">Giỏ Hàng</a></li>
                                            <li><a href="{{route('about.index')}}" class="nav-link menu-title">Về chúng tôi</a></li>
                ...
                <div class="row gy-4">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>Điện Thoại:</b> <span class="font-light"> +84 19995652</span></span>
                                </li>
                                <li>
                                    <span><b>Địa Chỉ:</b><span class="font-light"> Thủy Phương, Hương Thủy,TT Huế</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@surfsidemedia.vn</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="{{route('app.index')}}" class="font-dark">Trang Chủ</a>
                                    </li>
                                    <li>
                                        <a href="{{route('shop.index')}}" class="font-dark">Cửa Hàng</a>
                                    </li>
                                    <li>
                                        <a href="{{route('about.index')}}" class="font-dark">Chúng Tôi</a>
                                    </li>
                                    <li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 d-none d-sm-block">
                        <div class="footer-newsletter">
                            <h3>Hãy giữ liên lạc</h3>
                            <div class="form-newsletter">
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control color-4" placeholder="Địa Chỉ Email">
                                    <span class="input-group-text" id="basic-addon4"><i
                                            class="fas fa-arrow-right"></i></span>
                                </div>
                                <p class="font-dark mb-0">Luôn cập nhật những tin tức mới nhất và ưu đãi đặc biệt của chúng tôi.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    <div class="col-md-6">
                        <ul>
                            <li class="font-dark">Chúng tôi đồng ý:</li>
                            <li>
                                <a href="javascript:void(0)">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Phi kiet Media.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="modal-product">
                                ...
                                <div class="modal-contain-details">
                                    ...
                                    <div class="product-total">
                                        <h5>TOTAL : <span>1,140.00đ</span></h5>
                                    </div>
                                    <div class="shop-cart-button mt-3">
                                        <a href="shop-left-sidebar.php"
                                            class="btn default-light-theme conti-button default-theme default-theme-2 rounded">TIẾP TỤC MUA SẮM</a>
                                        <a href="cart.php"
                                            class="btn default-light-theme conti-button default-theme default-theme-2 rounded">XEM GIỎ HÀNG</a>
                                    </div>
                                </div>
                            </div>
                        </div>
